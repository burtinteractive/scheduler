...
(function( $ ){
	...
	$.fn.multiDatesPicker = function(method) {
		//console.log("here again init date picker");
		...
		function removeDate(date, type) {
			console.log("removing dates har har har");
			if(!type) type = 'picked';
		...
		var methods = {
			init : function( options ) {
				...
				var mdp_events = {
					...
					},removeDates2 : function(date){
							var $this = $(this);
							console.log("here on remove dates");
							removeDate(date, "picked");
	...
	$.multiDatesPicker.initialized = true;
	$.multiDatesPicker.uuid = new Date().getTime();
	$.multiDatesPicker.version = $.ui.multiDatesPicker.version;
	$.fn.multiDatesPicker.removeDate3= function(date){
		console.log(dates["picked"]);
		//console.log($.multiDatesPicker.removeDate());
		console.log("here in remove 3");
	//	removed = [];
